...
class Binary_Function_With_Bound_1st
{
  ...
  Ftn _f;
public:
  Binary_Function_With_Bound_1st(Ftn f, const Arg b): _b(b), _f(f) {}
...
class Binary_Function_With_Bound_2nd
{
  ...
  Ftn _f;
public:
  Binary_Function_With_Bound_2nd(Ftn f, Arg b): _b(b), _f(f) {}
...
class Binary_Function_With_Bound_2nd<Ret, const Arg&>
{
  ...
  Ftn _f;
public:
  Binary_Function_With_Bound_2nd(Ftn f, const Arg& b): _b(b), _f(f) {}
