...
*/
ITPP_EXPORT ivec oct2bin(const ivec &octalindex, short keepzeros = 0);
...
*/
ITPP_EXPORT ivec bin2oct(const ivec &inbits);

//! Convert bvec to polar binary representation as ivec
ITPP_EXPORT ivec bin2pol(const ivec &inbvec);

//! Convert binary polar ivec to bvec
ITPP_EXPORT ivec pol2bin(const ivec &inpol);
